...
//         return{...i, isdiscounted: false};
//     });

//     console.log(`promotion applied ${count} items discounted.
//         Total saving ${save}`);
...
// applyPromo(
//     cart,
//     i => i.category == "Electronics" && i.price >200
// );
...
// let result = rawMovies.map(m =>{
//     let[name,genre,views]= m.split("|");
//     views= Number(views)|| 0;

//     return{name,genre,views};
// })
// .filter(m=> 
// (m.genre ==="Action" || m.genre ==="Sci-Fi") && m.views>5000
// )
